...
<body>
	...
	<%	
		int i = 1;
		String manager_name = request.getParameter("data");
	...
	<div class="content clearfix">
		<div class="left">
		<img id="avatar_img" src="http://localhost:8080/Blog_System/GetImage?data=<%=session.getAttribute("pic_name") %>" class="avatar" onerror="this.src='image/timg.jpeg'" onclick="imageOnClick()"/>
